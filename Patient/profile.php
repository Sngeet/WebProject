    ...
    <div class="main-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row gutters-sm">
                ...
                $view = "SELECT `patient`.*,`login`.* FROM `patient`,`login` WHERE `patient`.`pid`=`login`.`rid` AND `login`.`rid`='$uid' AND `login`.`type`='Patient'";
                                ...
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="image-upload text-center">
                                        <label for="file-input">
                                            <img id="img" src="../images/patient.png" alt="Upload Image" style="margin: auto" class="rounded-circle" width="150" />
                                        </label>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <p class="text-secondary mb-1">Type : Patient</p>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="name" value="<?php echo $row['pname'] ?>" id="" class="form-control" required>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="email" name="email" value="<?php echo $row['pemail'] ?> " id="" class="form-control" required>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="phone" value="<?php echo $row['pphone'] ?>" id="" class="form-control" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="address" value="<?php echo $row['p_address'] ?>" id="" class="form-control" required>
...
if (isset($_REQUEST['submit'])) {
    ...
    $qryReg = "UPDATE `patient` SET `pname`='$Name',`pphone`='$Phone',`pemail`='$Email',`p_address`='$Address' WHERE `pid`='$uid'";
    $qryLog = "UPDATE `login` SET `password`='$hashed_password' WHERE `rid`='$uid' and `type`='Patient'";
